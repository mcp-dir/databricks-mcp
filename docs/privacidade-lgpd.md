...
Databricks segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **Databricks** | US | data platform API provider (provedor dos dados do usuário) |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [databricks@mcp.ai](mailto:databricks@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
